var face1,face2,flag=0,point1,point2,opoint1=0,opoint2=0;
        ...
        const playerSubsequent = function (ch,point1,board) {
            var point;
            var playerEl;
            var boardEl,buttonEl1, buttonEl2;
            if(board === 1) {
            ...
            boardEl.innerHTML = ''
            switch(ch) {
                case point1:playerEl = document.createElement('p')
                            playerEl.textContent = `You rolled ${ch}. You won!`
                            boardEl.appendChild(playerEl)
                            buttonEl1.style.display = "none";
                            buttonEl2.style.display = "none";
...
document.querySelector('#button2').addEventListener('click',function () {
    ...
    if(flag==1) {
        ...
        point2 = playerSubsequent(ch,point1,2);
        flag++;
    }
    opoint2+=point2;
